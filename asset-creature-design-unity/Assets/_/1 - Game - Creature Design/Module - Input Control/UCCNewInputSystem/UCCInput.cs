// GENERATED AUTOMATICALLY FROM 'Assets/_/1 - Game - Creature Design/Module - Input Control/UCCNewInputSystem/UCCInput.inputactions'
...
public class @UCCInput : IInputActionCollection, IDisposable
{
    ...
    {
        private @UCCInput m_Wrapper;
        public GameplayActions(@UCCInput wrapper) { m_Wrapper = wrapper; }
