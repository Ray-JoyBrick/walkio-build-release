namespace JoyBrick.Walkio.Game.Environment.Utility.EditorPart.Tests
{
    ...
    public class FlowFieldTileTest
    {
        ...
        public void GetTileCountFromGrid2D()
        {
            ...
            // act
            var tileCount2D =
                GameEnvironmentUtility.FlowFieldTileHelper.GetTileCountFromGrid2D(
                    gridCellCount,
                    gridCellSize,
                    tileCellCount,
                    tileCellSize);
        ...
        public void GetTileCountFromGrid1D()
        {
            ...
            // act
            var tileCount =
                GameEnvironmentUtility.FlowFieldTileHelper.GetTileCountFromGrid1D(
                    gridCellCount,
                    gridCellSize,
                    tileCellCount,
                    tileCellSize);
        ...
        public void GetTileIndexFromPosition2D()
        {
            ...
            // act
            var tileIndex =
                GameEnvironmentUtility.FlowFieldTileHelper.PositionToTileIndexAtGrid2D(
                    gridCellCount,
                    gridCellSize,
                    tileCellCount,
                    tileCellSize,
        ...
        public void GetTileIndexFromPosition1D()
        {
            ...
            // act
            var tileIndex =
                GameEnvironmentUtility.FlowFieldTileHelper.PositionToTileIndexAtGrid1D(
                    gridCellCount,
                    gridCellSize,
                    tileCellCount,
                    tileCellSize,
        ...
        public void GetPositionToTileAndTileCellIndexAtGridTo2DIndex()
        {
            ...
            // act
            var tileIndex =
                GameEnvironmentUtility.FlowFieldTileHelper.PositionToTileAndTileCellIndexAtGridTo2DIndex(
                    gridCellCount,
                    gridCellSize,
                    tileCellCount,
                    tileCellSize,
        ...
        public void GetPositionToTileAndTileCellIndexAtGridTo1DIndex()
        {
            ...
            // act
            var tileIndex =
                GameEnvironmentUtility.FlowFieldTileHelper.PositionToTileAndTileCellIndexAtGridTo1DIndex(
                    gridCellCount,
                    gridCellSize,
                    tileCellCount,
                    tileCellSize,
        ...
        public void GetGridCellIndexToTileAndTileCellIndexAtGridTo1DIndex()
        {
            ...
            // act
            var gridCellIndex1 =
                GameEnvironmentUtility.FlowFieldTileHelper.FromTileAndTileCellIndexToGridCellIndex2D(
        ...
        public void GetTileIndexFromGridCellIndex1D()
        {
            ...
            // act
            var tileIndex1 =
                GameEnvironmentUtility.FlowFieldTileHelper.FromGridCellIndexToTileIndex2D(
                    gridCellCount, gridCellSize,
                    tileCellCount, tileCellSize,
                    gridCellIndex1);
        ...
        public void GetDirectionFor04_04TileCase02_02()
        {
            ...
            // act
            var integrationCosts =
                GameEnvironmentUtility.FlowFieldTileHelper.GetDirectionForTile(
                    gridCellCount, gridCellSize,
                    tileCellCount, tileCellSize,
                    goalTileCellIndex, baseCosts);
        ...
        public void GetTileIndexPairOnPath()
        {
            ...
            // act
            var tileIndexPairs =
                GameEnvironmentUtility.FlowFieldTileHelper.GetTileIndexPairOnPath(
                    gridCellCount, gridCellSize,
                    tileCellCount, tileCellSize,
                    pathPoints);
        ...
        public void GetTilePairInfoOnPath()
        {
            ...
            // act
            var tilePairInfos =
                GameEnvironmentUtility.FlowFieldTileHelper.GetTilePairInfoOnPath(
                    gridCellCount, gridCellSize,
                    tileCellCount, tileCellSize,
                    pathPoints);
