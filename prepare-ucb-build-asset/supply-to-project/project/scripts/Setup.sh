...
md5=$(cat "$parentdir/references-checksum") && ./google-cloud-sdk/bin/gsutil cp "gs://${_GCS_BUCKET}/references-$md5.zip" "$parentdir/references.zip"
md5=$(cat "$parentdir/preprocessed-assets-checksum") && ./google-cloud-sdk/bin/gsutil cp "gs://${_GCS_BUCKET}/preprocessed-assets-$md5.zip" "$parentdir/preprocessed-assets.zip"
