namespace JoyBrick.Walkio.Game.Move.FlowField.Utility.EditorPart.Tests
{
    ...
    public class WorldMapGridTest
    {
        ...
        public void GetGridCellIndexFromPosition()
        {
            ...
            // act
            var gridCellIndex =
                GameMoveFlowFieldUtility.WorldMapGridHelper.PositionToGridCellIndex2D(
                    gridCellCount,
                    gridCellSize,
        ...
        public void GetOutBoundIndex1DFromPosition()
        {
            ...
            // act
            var gridCellIndex1 =
                GameMoveFlowFieldUtility.WorldMapGridHelper.PositionToGridCellIndex1D(
                    gridCellCount,
                    gridCellSize,
        ...
        public void GetPositionFromGridCellIndex()
        {
            ...
            // act
            var position =
                GameMoveFlowFieldUtility.WorldMapGridHelper.GridCellIndexToPosition2D(
                    gridCellCount,
                    gridCellSize,
                    gridCellIndex);
