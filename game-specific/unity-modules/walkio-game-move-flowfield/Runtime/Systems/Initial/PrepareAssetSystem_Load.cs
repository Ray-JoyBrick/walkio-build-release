namespace JoyBrick.Walkio.Game.Move.FlowField
{
    ...
    public partial class PrepareAssetSystem : SystemBase
    {
            ...
            System.Action loadingDoneAction)
        {
            ...
            //     .Subscribe(result =>
            //     {
            //         _logger.Debug($"Module - Move - FlowField - LoadAssetSystem - InternalLoadAsset");
            //
            //         //
        ...
        private void RegisterToLoadFlow()
        {
            ...
            FlowControl?.AssetLoadingStarted
                ...
                .Subscribe(x =>
                {
                    _logger.Debug($"Module - Move - FlowField - LoadAssetSystem - Construct - Receive AssetLoadingStarted");
