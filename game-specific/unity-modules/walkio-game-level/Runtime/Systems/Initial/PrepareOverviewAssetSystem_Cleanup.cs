namespace JoyBrick.Walkio.Game.Level
{
    ...
    public partial class PrepareOverviewAssetSystem
    {
        ...
        {
            _logger.Debug($"Module - Level - PrepareOverviewAssetSystem - RegisterToCleanupFlow");
            ...
            FlowControl?.AssetUnloadingStarted
                ...
                .Subscribe(x =>
                {
                    _logger.Debug($"Module - Level - PrepareOverviewAssetSystem - RegisterToCleanupFlow - Receive AssetUnloadingStarted");
