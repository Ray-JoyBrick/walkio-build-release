namespace JoyBrick.Walkio.Game.Hud.Preparation
{
    ...
    public partial class PrepareAssetSystem
    {
        ...
        {
            _logger.Debug($"Module - Hud Preparation - PrepareAssetSystem - RegisterToCleanupFlow");
            ...
            FlowControl?.AssetUnloadingStarted
                ...
                .Subscribe(x =>
                {
                    _logger.Debug($"Module - Hud Preparation - PrepareAssetSystem - Construct - Receive AssetUnloadingStarted");
