namespace JoyBrick.Walkio.Game.Hud.App
{
        ...
        // GameCommon.ISystemContext
    {
            ...
            System.Action loadingDoneAction)
        {
            ...
            Load(hudAssetName).ToObservable()
                ...
                .Subscribe(result =>
                {
                    ...
                    if (_hudData != null)
                    {
                        _logger.Debug($"Module - Hud - {AtPart} - PrepareAssetSystem - InternalLoadAsset - hud data is not null");
                        ...
                        _canvas.name = _canvas.name + $" - {AtPart}";
#endif
        ...
        {
            _logger.Debug($"Module - Hud {AtPart} - PrepareAssetSystem - RegisterToLoadFlow");
            ...
            FlowControl?.AssetLoadingStarted
                ...
                .Subscribe(x =>
                {
                    ...
                    var hudAssetName = $"Hud - {AtPart}/Hud Data";
