namespace JoyBrick.Walkio.Game.Hud.App
{
    ...
    public partial class PrepareAssetSystem
    {
        ...
        {
            _logger.Debug($"Module - Hud {AtPart} - PrepareAssetSystem - RegisterToCleanupFlow");
            ...
            FlowControl?.AssetUnloadingStarted
                ...
                .Subscribe(x =>
                {
                    _logger.Debug($"Module - Hud {AtPart} - PrepareAssetSystem - Construct - Receive AssetUnloadingStarted");
