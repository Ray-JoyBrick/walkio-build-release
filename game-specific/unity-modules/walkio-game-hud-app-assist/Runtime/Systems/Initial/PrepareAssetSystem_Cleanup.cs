namespace JoyBrick.Walkio.Game.Hud.App.Assist
{
    ...
    public partial class PrepareAssetSystem
    {
        ...
        {
            _logger.Debug($"Module Assist - Hud {AtPart} - PrepareAssetSystem - RegisterToCleanupFlow");
            ...
            FlowControl?.AssetUnloadingStarted
                ...
                .Subscribe(x =>
                {
                    _logger.Debug($"Module Assist - Hud {AtPart} - PrepareAssetSystem - Construct - Receive AssetUnloadingStarted");
