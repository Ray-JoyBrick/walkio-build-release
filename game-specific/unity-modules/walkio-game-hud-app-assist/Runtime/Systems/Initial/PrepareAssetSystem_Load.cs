namespace JoyBrick.Walkio.Game.Hud.App.Assist
{
        ...
        // GameCommon.ISystemContext
    {
            ...
            System.Action loadingDoneAction)
        {
            ...
            Load(hudAssetName).ToObservable()
                ...
                .Subscribe(result =>
                {
                    ...
                    if (_hudData != null)
                    {
                        _logger.Debug($"Module Assist - Hud - {AtPart} - PrepareAssetSystem - InternalLoadAsset - hud data is not null");
                        ...
                        _canvas.name = _canvas.name + $" - {AtPart} Assist";
#endif
                    ...
                    {
                        _logger.Debug($"Module Assist - Hud - {AtPart} - PrepareAssetSystem - InternalLoadAsset - hud data is null");
                    }
        ...
        {
            _logger.Debug($"Module Assist - Hud {AtPart} - PrepareAssetSystem - RegisterToLoadFlow");
