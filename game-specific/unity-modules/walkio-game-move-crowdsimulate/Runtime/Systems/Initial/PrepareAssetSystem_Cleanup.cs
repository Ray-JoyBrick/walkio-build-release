    ...
    public partial class PrepareAssetSystem : SystemBase
    {
            ...
            System.Action unloadingDoneAction)
        {
            ...
            Unload().ToObservable()
                ...
                .Subscribe(result =>
                {
                    _logger.Debug($"Module - Move - CrowdSimulate - PrepareAssetSystem - InternalUnloadAsset");
        ...
        private void RegisterToCleanupFlow()
        {
            ...
            FlowControl?.AssetUnloadingStarted
                ...
                .Subscribe(x =>
                {
                    _logger.Debug($"Module - Move - CrowdSimulate - PrepareAssetSystem - Construct - Receive AssetUnloadingStarted");
