    ...
    public partial class PrepareAssetSystem : SystemBase
    {
            ...
            System.Action unloadingDoneAction)
        {
            ...
            Unload().ToObservable()
                ...
                .Subscribe(result =>
                {
                    _logger.Debug($"Module - Move - Waypoint - PrepareAssetSystem - InternalUnloadAsset");
        ...
        private void RegisterToCleanupFlow()
        {
            ...
            FlowControl?.AssetUnloadingStarted
                ...
                .Subscribe(x =>
                {
                    _logger.Debug($"Module - Move - Waypoint - PrepareAssetSystem - Construct - Receive AssetUnloadingStarted");
