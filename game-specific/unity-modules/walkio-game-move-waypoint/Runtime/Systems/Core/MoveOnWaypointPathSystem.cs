namespace JoyBrick.Walkio.Game.Move.Waypoint
{
    ...
    public class MoveOnWaypointPathSystem : SystemBase
    {
        ...
        {
            _logger.Debug($"Module - Move - Waypoint - MoveOnWaypointPathSystem - Construct");
            ...
            FlowControl?.FlowReadyToStart
                ...
                .Subscribe(x =>
                {
                    _logger.Debug($"Module - Move - Waypoint - MoveOnWaypointPathSystem - Construct - Receive FlowReadyToStart");
                    _canUpdate = true;
                })
