namespace JoyBrick.Walkio.Build.BattleExport.Editor
{
    ...
    public partial class AssetCreator
    {
        ...
        [MenuItem("Assets/Walkio/Export/Battle Asset Package")]
        public static void ExportPackage()
        {
            ...
            var packagePath = Path.Combine(parentDirectory.FullName, "Battle Battle.unitypackage");
