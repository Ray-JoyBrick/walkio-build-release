    ...
    public class MoveOnFlowFieldTileSystem : SystemBase
    {
        ...
        protected override void OnUpdate()
        {
            ...
            Entities
                ...
                .ForEach((Entity entity, GameEnvironment.MoveOnFlowFieldTileInfo moveOnFlowFieldTileInfo, ref PhysicsVelocity physicsVelocity, ref PhysicsMass physicsMass, ref Translation translation) =>
                {
                    var tileEntity = moveOnFlowFieldTileInfo.OnTile;
                    if (tileEntity != Entity.Null)
                    {
                        ...
                        var lookup = GetBufferFromEntity<GameEnvironment.FlowFieldTileCellBuffer>();
