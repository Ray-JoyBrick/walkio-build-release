    ...
    public class AssignFlowFieldTileToTeamUnitSystem : SystemBase
    {
        ...
        protected override void OnUpdate()
        {
            ...
            Entities
                ...
                .ForEach((Entity entity, TeamForce teamForce, Translation translation) =>
                {
                    var hasTeamIdInCache = teamUnitToPathSystem.CachedEntities.ContainsKey(teamForce.TeamId);

                    if (hasTeamIdInCache)
                    {
                        var tileTable = teamUnitToPathSystem.CachedEntities[teamForce.TeamId];
                        ...
                        if (hasCachedTileEntity)
                        {
                            ...
                            commandBuffer.SetComponent(entity, new GameEnvironment.MoveOnFlowFieldTileInfo
                            {
                                OnTile = tileEntity
                            });
                        }
