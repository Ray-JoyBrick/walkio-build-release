namespace JoyBrick.Walkio.Game.Battle
{
    ...
    {
        private static readonly UniRx.Diagnostics.Logger _logger = new UniRx.Diagnostics.Logger(nameof(NeutralForceUnitHitCheckSystem));
        ...
        public void Construct()
        {
            ...
            FlowControl.AllDoneSettingAsset
                ...
                .Subscribe(x =>
                {
                    _logger.Debug($"NeutralForceUnitHitCheckSystem - Construct - Receive AllDoneSettingAsset");
                    _canUpdate = true;
                })
        ...
        //
        //     //
        //     public ComponentDataFromEntity<NeutralForce> neutralForceGroup;
        //     [ReadOnly] public ComponentDataFromEntity<NeutralForceUnitAbsorbable> neutralForceUnitAbsorbableGroup;
        //
        ...
        //
        //         var entityAIsPickUpUnit = neutralForceGroup.Exists(entityA);
        //         var entityBIsPickupAbsorbable = neutralForceUnitAbsorbableGroup.Exists(entityB);
        //         
        //         if (entityAIsPickUpUnit && entityBIsPickupAbsorbable)
        //         {
        //             _logger.Debug($"entityAIsPickUpUnit && entityBIsPickupAbsorbable");
        //
        //             var pickupUnit = pickupGroup[entityA];
        //
        //             if (!pickupUnit.Interacted)
        //             {
        //                 var pickupAbsorbable = pickupAbsorbableGroup[entityB];
        //
        ...
        //         else
        //         {
        //             var entityAIsPickupAbsorbable = pickupAbsorbableGroup.Exists(entityA);
        //             var entityBIsPickUpUnit = pickupGroup.Exists(entityB);
        //             if (entityAIsPickupAbsorbable && entityBIsPickUpUnit)
        //             {
        //                 _logger.Debug($"entityAIsPickupAbsorbable && entityBIsPickUpUnit");
        //
        //                 var pickupUnit = pickupGroup[entityB];
        //
        //                 if (!pickupUnit.Interacted)
        //                 {
        //                     var pickupAbsorbable = pickupAbsorbableGroup[entityA];
        //
        //                     pickupUnit.Interacted = true;
        //
        //                     entityCommandBuffer.CreateEntity(eventEntityArchetype);
        ...
        protected override void OnUpdate()
        {
            ...
            //     pickupGroup = GetComponentDataFromEntity<Pickup>(),
            //     pickupAbsorbableGroup = GetComponentDataFromEntity<PickupAbsorbable>(true)
            // };
            //
