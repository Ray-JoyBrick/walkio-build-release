namespace JoyBrick.Walkio.Game.Common.Utility.Tests
{
    ...
    public class MortonCode2d32BitTest
    {
        private static readonly int[] _mortonCodeLutX =
        {
            0, 1, 4, 5, 16, 17, 20, 21,
        ...
        private static readonly int[] _mortonCodeLutY =
        {
        ...
        public void EncodeX0Y0Is0()
        {
            ...
            // act
            var expected = 0;
            var actual = MortonCode2d32Bit.Encode(new MortonCode2d32Bit.Index2d {X = (short) x, Y = (short) y});
        ...
        [Test]
        public void EncodeX71Y91Is12959()
        {
            // arrange
            var x = 71;
            var y = 91;
        ...
        [Test]
        public void Decode12959IsX71Y91()
        {
            // arrange
            var v = 12959;

            // act
            var expected = new MortonCode2d32Bit.Index2d {X = 71, Y = 91};
            var actual = MortonCode2d32Bit.Decode(12959);
        ...
        [Test]
        public void EncodeThenDecodeShouldBeEqual()
        {
            // arrange
            var x = 201;
            var y = 37;
            ...
            // act
            var expected = new MortonCode2d32Bit.Index2d {X = (short) x, Y = (short) y};

            var encoded = MortonCode2d32Bit.Encode(new MortonCode2d32Bit.Index2d {X = (short) x, Y = (short) y});
            var actual = MortonCode2d32Bit.Decode(encoded);
        ...
        [Test]
        public void IndexFromLutShouldBeEqualToEncoded()
        {
            // arrange
            var x = 45;
            var y = 66;
            ...
            // act
            var expected = MortonCode2d32Bit.Encode(new MortonCode2d32Bit.Index2d {X = (short) x, Y = (short) y});
            var actual =
                MortonCode2d32Bit.RestoredIndexFromLut(
                    _mortonCodeLutX, _mortonCodeLutY, 
                    new MortonCode2d32Bit.Index2d { X = (short) x, Y = (short) y });
